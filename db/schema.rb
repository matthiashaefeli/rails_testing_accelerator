...
ActiveRecord::Schema.define(version: 2020_05_15_201912) do
  ...
  create_table "reclucks", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["cluck_id", "user_id"], name: "index_reclucks_on_cluck_id_and_user_id", unique: true
    t.index ["cluck_id"], name: "index_reclucks_on_cluck_id"
    t.index ["user_id"], name: "index_reclucks_on_user_id"
  end
